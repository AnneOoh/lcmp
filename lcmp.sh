...
# 生成 22位 僅包含字母與數字的字串
# _info "PMA_Random_String = $(head -c 100 /dev/urandom | tr -dc 'abcdefghijkmnpqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ23456789_' | fold -w 22 | head -n 1)"
# 更改目錄名稱
# _error_detect "mv /data/www/default/pma/ /data/www/default/${PMA_Random_String}/"
